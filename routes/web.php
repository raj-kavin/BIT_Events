...
Route::post('/event',[DatabaseController::class, 'Event']);


Route::post('/eventapproval',[DatabaseController::class, 'EventApproval']);
...
Route::get('/view-events-approval/{id}',[PageController::class, 'ViewEventsApprovalController']);
