        ...
        <div class="container ">
            <div class="row">
                @if ($errors->any())
                    ...
                    @endforeach
                @endif
                <div class="col-sm-10 login-box" style="border-radius:20px; overflow:hidden">
                    <div class="row" style="background-color: white;">
                        <div class="col-lg-6 col-md-6 log-det "
                            style="background: rgb(28,25,64);
                            background: linear-gradient(19deg, rgba(28,25,64,1) 12%, rgba(28,25,64,1) 45%, rgba(0,212,255,1) 100%); border:20px solid white; border-radius:40px;">
                            <div
                                style="border: 5px solid white; padding:10px;border-radius:20px"
                            >
                                <div class="d-flex align-items-center justify-content-center">
                                    <img src="https://www.bitsathy.ac.in/wp-content/themes/baiotsathycollege/assets/images/header 06.png"
                                        style="height: 50px">
                                </div>
                                <h2 class="mb-3 text-white">BIT Camps<br></h2>
                                ...
                                <div class="form-check form-check-inline mb-3">
                                    ...
                                    <label class="form-check-label" for="inlineRadio2">Student Login</label>
                                        ...
                                        <div class="input-group center mb-3">
                                            <button type="submit" value="Login" class="btn btn-login btn-round">LOG
                                                IN</button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 box-de" style="background-color: white">
                            <div class="ditk-inf">
                                <img src="{{ asset('login-template') }}/images/login-cover.jpg">
                            </div>
                        </div>
                    </div>
                </div>
